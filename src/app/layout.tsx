...
const syne = Syne({ subsets: ["latin"], variable: "--font-space" });
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark antialiased">
      <body
        className={`${plusJakarta.variable} ${syne.variable} ${jetbrains.variable} font-sans min-h-screen flex flex-col bg-black text-white overflow-x-hidden relative`}
      >
